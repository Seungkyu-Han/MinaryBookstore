...
interface BookForRentService {
    fun get(id: Int, authentication: Authentication?): ResponseEntity<BookForRentGetRes>
    ...
    fun deleteSave(bookForRentId: Int, authentication: Authentication): ResponseEntity<HttpStatus>
}